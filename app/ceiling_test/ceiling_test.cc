...
int main() {
    ...
    cout << "\nYou need to analyze the priority for Thread C after the message A trying to acquire the semaphore" << endl;
    cout << "you will see thread C ceiling aplicated equals -1000" << endl;
...
int func_a() {
    ...
    // suas prioridades estao sendo alteradas pro ceiling (-1000)
